...
namespace HealthMed.Web.Controllers.TabelaDominio
{
    ...
    {
        private readonly IHorarioAppService _appService;

        public HorarioController(IHorarioAppService appService, INotificationHandler<DomainNotification> notifications, IMediatorHandler mediator)
